...
module.exports = (function() {
  ...
  PulsarExec.prototype.setPulsarOption = function(key, value) {
    this._args.pulsarOptions.push(key + ' ' + value);
  };
  ...
  PulsarExec.prototype.getCommandArgs = function() {
    var args = [];
    var pulsarOptions = this._optionsToSpawnFormat(this._args.pulsarOptions);
    var capistranoOptions = this._optionsToSpawnFormat(this._args.capistranoOptions);
