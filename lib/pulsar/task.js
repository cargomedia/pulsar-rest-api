...
module.exports = (function () {
  ...
  PulsarTask.prototype.kill = function () {
    try{
      //Don't use child_process.kill because of it's async error handling.
      process.kill(this._taskProcess.pid, 'SIGTERM');
      setTimeout(this._killTimeout.bind(this), PulsarTask._KILL_TIMEOUT);
    } catch(e){
      this._onKillError(e);
    }
    this.onUpdate();
  ...
  PulsarTask.prototype._killTimeout = function () {
    try{
