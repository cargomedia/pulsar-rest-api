...
module.exports = (function () {
    ...
    var PulsarDB = function (host, port) {
        this.connect(
            host || 'localhost',
            port || 27017
        );
    ...
    PulsarDB.MONGO_DB_NAME = 'pulsar';
    PulsarDB.MONGO_COLLECTION_NAME = 'tasks';
    ...
    PulsarDB.prototype.connect = function (host, port) {
        var self = this;
        var url = 'mongodb://' + host + ':' + port + '/' + PulsarDB.MONGO_DB_NAME;
        ...
        MongoClient.connect(url, function (err, db) {
            ...
            self.db = db;
            self.collection = db.collection(PulsarDB.MONGO_COLLECTION_NAME);
        });
