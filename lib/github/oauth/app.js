...
module.exports = (function() {
  ...
  var create = function(clientId, clientSecret) {
    engine = new OAuth.OAuth2(clientId, clientSecret, baseSite, authorizePath, accessTokenPath, customHeaders);
  };

  OAuth2.prototype.getAccessToken = function() {
    engine.getOAuthAccessToken(code || '', params || {'grant_type': 'client_credentials'}, callback || function(e, access_token, refresh_token, results) {
