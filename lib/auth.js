...
var oAuthToken = require('./github/oauth/token.js');
var oAuthApp = require('./github/oauth/app.js');
...
module.exports = (function() {
	...
	var createAuth = function(options) {
		if (options) {
			if (options.provider == 'github' && options.method == 'user') {
				gate = new githubApi(options.username, options.password);
